...
export default function ProfilePage() {
  ...
  useEffect(() => { const session = storage.getSession(); if (!session) { router.replace("/login"); return; } setIsAdmin(session.role === "admin"); setProfile(storage.getProfile() ?? defaultProfile); setHistory(storage.getSearchHistory()); setFavoriteIds(storage.getFavorites()); setReady(true); }, [router]);
